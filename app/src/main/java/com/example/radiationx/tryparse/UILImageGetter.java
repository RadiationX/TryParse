...
public class UILImageGetter implements Html.ImageGetter {
    ...
    public Drawable getDrawable(String source) {
        Log.d("kek", "SOURCE "+source);
        source = "http://beardycast.com/"+source;
        UrlImageDownloader urlDrawable = new UrlImageDownloader(c.getResources(), source);
        urlDrawable.drawable = c.getResources().getDrawable(R.drawable.asd);
    ...
    private class SimpleListener extends SimpleImageLoadingListener {
        ...
        public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
            ...
            Log.d("lol", container.getTop()+" "+imageUri);
